...
- `Faster First Export`
  Opening the export menu can freeze Flashback for a couple of seconds. This feature gets the export tools ready shortly after you open a replay, so the export window feels faster.
- `Timeline Horizontal Scroll`
  Enables horizontal scrolling with a mouse side wheel, horizontal wheel, or trackpad panning in the Flashback timeline.
